...
export default function SettingsPage() {
    ...
    const handleInvite = () => {
        toast({
            ...
            description: "In a real app, an invitation email would be sent.",
        });
    }
  ...
  return (
    <ProtectedComponent permissionKey="page:settings" fallback={<AccessDeniedFallback />}>
      <PageHeader
        title="Settings"
        description="Manage portal users, notifications, and API keys."
      />
            ...
            <CardContent className="space-y-4">
                <div className="flex items-center justify-between rounded-lg border p-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Receive a summary of key metrics every Monday.</p>
                    </div>
                 ...
                 <div className="flex items-center justify-between rounded-lg border p-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Get notified about critical and major platform incidents.</p>
                    </div>
        ...
        <ProtectedComponent permissionKey="widget:api_keys">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Scoped, non-PHI API keys for programmatic access to aggregate data.</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="flex items-center gap-4 rounded-lg border p-4 bg-muted/50">
                        <Key className="h-8 w-8 text-muted-foreground" />
                        <Input readOnly value="a1b2c3d4-****-****-****-************efgh" className="font-mono" />
